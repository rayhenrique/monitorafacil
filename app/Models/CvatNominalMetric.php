...
class CvatNominalMetric extends Model
{
    protected $fillable = [
        ...
        'source',
        'reference_date',
        'benefit_data_available',
        'excluded_without_pec_id',
        'pbf_import_id',
        'pbf_vigencia',
        'pbf_confirmed_total',
        'last_record_date',
    ...
    protected function casts(): array
    {
        return [
            ...
            'month' => 'integer',
            'reference_date' => 'date',
            'benefit_data_available' => 'boolean',
            'excluded_without_pec_id' => 'integer',
            'pbf_import_id' => 'integer',
            'pbf_confirmed_total' => 'integer',

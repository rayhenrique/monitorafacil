 ...
 * @property string|null $ciap_codes
 * @property string|null $cid_codes
 * @property Carbon|null $first_diagnosis_date
 * @property Carbon|null $last_diagnosis_date
 ...
 * @property Carbon|null $last_pa_date
 * @property string|null $last_pa_value

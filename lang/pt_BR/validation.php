...
return [
    ...
    | as regras de tamanho. Fique à vontade para ajustar qualquer uma dessas mensagens.
    |
    */
    ...
    'any_of' => 'O campo :attribute deve ser um dos valores fornecidos.',
    ...
    'string' => 'O campo :attribute deve ser uma string de texto.',
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para trocar o placeholder de atributo

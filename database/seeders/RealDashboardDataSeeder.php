...
class RealDashboardDataSeeder extends Seeder
{
    ...
    {
        // 1. Consolidação de Cadastros (Q3/2026) - Dados Reais Oficiais (NT 30/2025)
        // Total Geral MICI: 37.002 (36.705 atualizados [99,20%] + 297 desatualizados [0,80%])
        // Total com MICDT: 36.289 (35.939 atualizados [99,04%] + 116 desatualizados [0,32%])
        ConsolidationRegistration::query()->updateOrCreate(
            ['year' => 2026, 'quarter' => 3],
            [
                'mici_updated_count' => 36705,
                'mici_outdated_count' => 297,
                'micdt_updated_count' => 35939,
                'micdt_outdated_count' => 116,
            ]
        );

        if (Schema::hasTable('cvat_nominal_metrics')) {
            CvatNominalMetric::query()->updateOrCreate(
                ['year' => 2026, 'month' => 9],
                [
                    ...
                    'mici_updated' => 36705,
                    'mici_outdated' => 297,
                    'mici_without_micdt_total' => 713,
                    'mici_updated_micdt_outdated_or_none' => 766,
                    'mici_updated_without_micdt' => 595,
                    'mici_with_micdt_total' => 36289,
                    'mici_and_micdt_updated' => 35939,
                    'mici_and_micdt_outdated' => 116,
                    'citizens_linked' => 37001,

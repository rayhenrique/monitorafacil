...
return new class extends Migration
{
    ...
    {
        Schema::create('c5_cohort_snapshots', function (Blueprint $table): void {
            $table->id();
            ...
            $table->unique(['year', 'quarter', 'ine'], 'unique_c5_cohort_team_period');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('c5_cohort_snapshots');
    }
};

...
return new class extends Migration
{
    ...
    {
        Schema::create('c6_nominal_elderly', function (Blueprint $table): void {
            $table->id();
            ...
            // Contagens e Metas das 4 Boas Práticas Clínicas (Quadro 01 - C6)
            // (A) Consulta Médica ou de Enfermagem nos últimos 12 meses (25 pts)
            ...
            // (B) Antropometria Simultânea (Peso e Altura) nos últimos 12 meses (25 pts)
            ...
            // (C) Visitas ACS com intervalo >= 30 dias nos últimos 12 meses (25 pts - eAP tipo 76 normalizada)
            $table->unsignedSmallInteger('practice_c')->default(0);
            $table->boolean('practice_c_met')->default(false);
            $table->date('last_visit_date')->nullable();

            // (D) Vacinação contra Influenza nos últimos 12 meses (25 pts)
            ...
            $table->string('last_vaccine_name', 100)->nullable();
            ...
            $table->index(['year', 'quarter', 'ine'], 'idx_c6_nominal_period_ine');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('c6_nominal_elderly');
    }
};
